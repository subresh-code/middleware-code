...
async def send_iso_message(payload: IsoMessageRequest):
    ...
    try:
        # 1. Encode JSON to ISO 8583 binary
        ...
        try:
            ...
            # 4. Read Response (Header + Message)
            ...
            return {
                ...
                "message": f"Rafiki processed. Response Code: {msg.de39} (00=Success, 14=WalletNotFound, 96=SystemError)"
            }
        finally:
            writer.close()
