...
class Settings(BaseSettings):
    ...
    rafiki_admin_secret: str = Field(..., alias="RAFIKI_ADMIN_SECRET")
    rafiki_webhook_secret: str = Field(..., alias="RAFIKI_WEBHOOK_SECRET")
    rafiki_admin_url: str = Field("", alias="RAFIKI_ADMIN_URL")
    rafiki_open_payments_url: str = Field("", alias="RAFIKI_OPEN_PAYMENTS_URL")
